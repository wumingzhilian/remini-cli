...
3. 只读工具最小实现：
   ...
   - `grep_search`
4. 命令最小实现：
   - Slash：`/about`、`/auth`、`/bug`、`/clear`、`/commands`、`/compress`、`/copy`、`/directory`、`/docs`、`/editor`、`/help`、`/ide`、`/init`、`/model`、`/model set <name>`、`/privacy`、`/quit`、`/resume`、`/settings`、`/stats`、`/terminal-setup`、`/theme`、`/tools`、`/tools desc|nodesc`
   - At：`@path`（文件/目录最小展开）
